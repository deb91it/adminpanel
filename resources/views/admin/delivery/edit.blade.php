...
{{--                </form>--}}
        ...
        {!! Form::open(['route' => ['admin.deliveries.update', $delivery->id], 'role' => 'form', 'method' => 'post', 'id' => "update-delivery"]) !!}
                ...
                <div class="m-section__content">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-4 {!! $errors->has('receipent_alternative_number') ? 'has-error' : ''  !!}">
                            <div class="form-group">
                                ...
                                {!! Form::text('receipent_alternative_number', $delivery->receipent_alternative_number, ['class' => 'form-control m-input','id'=>'recipient_email','value'=>Input::old('receipent_alternative_number'), 'placeholder' => 'Enter recipient alternative number !', 'tabindex' => '3']) !!}
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-4 {!! $errors->has('plan') ? 'has-error' : ''  !!}">
                            <div class="form-group">
                                <label>Delivered Plan<span class="text-danger">*</span></label>
                                <select class="form-control" name="plan" id="selectPlan" tabindex="11">
{{--                                    <option>Please Select</option>--}}
                                    @forelse($deliveredPlan as $p)
...
{{--                                {!! Form::select('plan', $plan, $delivery->plan_id, array('class' => 'form-control m-input','id'=>'selectPlan', 'value'=>Input::old('plan'), 'placeholder' => 'select plan !', 'tabindex' => '8')) !!}--}}
                        ...
                        <div class="col-md-4 {!! $errors->has('plan_returned_id') ? 'has-error' : ''  !!}">
                            <div class="form-group">
                                <label>Returned Plan<span class="text-danger">*</span></label>
                                <select class="form-control" name="plan_returned_id" id="selectPlanReturn" tabindex="12">
{{--                                    <option>Please Select</option>--}}
                                    @forelse($returnedPlan as $p)
                                    <option value="{{$p->plan_id}}" {{$delivery->plan_id == $p->plan_id ? 'selected' : ''}}>{{$p->plan_name}}</option>
                                        @empty
                                    <p></p>
                                        @endforelse
    ...
    <script>
        ...
        $(document).ready(function () {
            $(".reset-form").click(function() {
                $(':input','#update-delivery').not(':button, :submit, :reset, :hidden').val('').removeAttr('checked').removeAttr('selected');
            });
            $("#div_hub").hide();
            $("#div_assign").hide();
