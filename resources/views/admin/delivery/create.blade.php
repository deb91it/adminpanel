        ...
        <div class="m-portlet__body">
            <div class="m-section">
                <div class="m-section__content">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-3 {!! $errors->has('recipient_name') ? 'has-error' : ''  !!}">
                        ...
                        <div class="col-md-3 {!! $errors->has('recipient_number') ? 'has-error' : ''  !!}">
                            <div class="form-group">
                        ...
                        <div class="col-md-2 {!! $errors->has('recipient_email') ? 'has-error' : ''  !!}">
                            <div class="form-group">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-4 {!! $errors->has('receipent_alternative_number') ? 'has-error' : ''  !!}">
                            <div class="form-group">
                                <label>Recipient Alternative Number</label>
                                {!! Form::text('receipent_alternative_number', null, ['class' => 'form-control m-input','id'=>'receipent_alternative_number','value'=>Input::old('receipent_alternative_number'), 'placeholder' => 'Enter recipient alternative number !', 'tabindex' => '4']) !!}
                                {!! $errors->first('receipent_alternative_number', '<label class="error_txt_size">:message</label>') !!}
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 {!! $errors->has('recipient_zone') ? 'has-error' : ''  !!}">
                            <div class="form-group">
                                ...
                                {!! Form::select('recipient_zone', $zone, null, array('class' => 'form-control m-input','id'=>'selectZone','value'=>Input::old('recipient_zone'), 'placeholder' => 'Select recipient zone !', 'tabindex' => '5')) !!}
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-4 {!! $errors->has('recipient_address') ? 'has-error' : ''  !!}">
                            <div class="form-group">
                                ...
                                {!! Form::text('recipient_address', null, ['class' => 'form-control m-input recipient_address','id'=>'','value'=>Input::old('recipient_email'), 'placeholder' => 'Enter recipient address !', 'tabindex' => '6']) !!}
...
{{--                                {!! Form::select('recipient_zone', $zone, null, array('class' => 'form-control m-input','id'=>'selectZone','value'=>Input::old('recipient_zone'), 'placeholder' => 'Select recipient zone !', 'tabindex' => '4')) !!}--}}
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8 {!! $errors->has('g_map_recipient_address') ? 'has-error' : ''  !!}">
                            <div class="form-group">
                                <label>Google Map Verified Address</label>
                                {!! Form::text('g_map_recipient_address', null, ['class' => 'form-control m-input g_map_recipient_address','id'=>'recipient_address', 'rows' => "6", 'value'=>Input::old('recipient_address'), 'placeholder' => 'Enter recipient address !', 'tabindex' => '7']) !!}
                    ...
                    <div class="row">
                        <div class="col-md-4 col-md-offset-2 {!! $errors->has('merchant') ? 'has-error' : ''  !!}">
                            <div class="form-group">
                                ...
                                {!! Form::select('merchant', $merchant, null, array('class' => 'form-control m-input selectMerchant','id'=>'selectMerchant','value'=>Input::old('merchant'), 'placeholder' => 'Select merchant!', 'tabindex' => '8')) !!}
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-4 {!! $errors->has('store') ? 'has-error' : ''  !!}">
                            <div class="form-group">
                                <label>Store</label>
                                {!! Form::select('store', ['First select merchant'], null, array('class' => 'form-control m-input','id'=>'selectStore','value'=>Input::old('store'), 'tabindex' => '9')) !!}
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8 {!! $errors->has('package_description') ? 'has-error' : ''  !!}">
                            <div class="form-group">
                                ...
                                {!! Form::textarea('package_description', null, ['class' => 'form-control m-input','id'=>'package_description', 'rows' => "6", 'value'=>Input::old('package_description'), 'placeholder' => 'Enter recipient address !', 'tabindex' => '10']) !!}
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-4 {!! $errors->has('plan') ? 'has-error' : ''  !!}">
                            <div class="form-group">
                                <label>Delivery Plan<span class="text-danger">*</span></label>
                                {!! Form::select('plan', $plan, null, array('class' => 'form-control m-input','id'=>'selectPlan', 'value'=>Input::old('plan'), 'placeholder' => 'select plan !', 'tabindex' => '12')) !!}
                                {!! $errors->first('plan', '<label class="error_txt_size">:message</label>') !!}
                            </div>
                        </div>
                        <div class="col-md-4 {!! $errors->has('plan_returned_id') ? 'has-error' : ''  !!}">
                            <div class="form-group">
                                <label>Return Plan<span class="text-danger">*</span></label>
                                {!! Form::select('plan_returned_id', $plan, null, array('class' => 'form-control m-input','id'=>'selectPlanReturn', 'value'=>Input::old('plan_returned_id'), 'placeholder' => 'select plan !', 'tabindex' => '13')) !!}
                                {!! $errors->first('plan_returned_id', '<label class="error_txt_size">:message</label>') !!}
                            </div>
                        </div>
                    </div>
                    <div class="row justify-content-center">
                        <div class="col-md-4 {!! $errors->has('amount_to_be_collected') ? 'has-error' : ''  !!}">
                            <div class="form-group">
                                <label>Amount to be Collected<span class="text-danger">*</span></label>
                                {!! Form::number('amount_to_be_collected', null, ['class' => 'form-control m-input','id'=>'amount_to_be_collected', 'value'=>Input::old('amount_to_be_collected'), 'placeholder' => 'Enter amount !', 'tabindex' => '11']) !!}
...
{{--                                    {!! Form::text('delivery_date', null, ['class' => 'form-control m-input','id'=>'delivery_date','value'=>Input::old('delivery_date'), 'placeholder' => 'Enter delivery date', 'tabindex' => '14']) !!}--}}
...
{{--                        </div>--}}
                        <div class="col-md-4 {!! $errors->has('merchant_order_id') ? 'has-error' : ''  !!}">
                            <div class="form-group">
                                ...
                                {!! Form::text('merchant_order_id', null, ['class' => 'form-control m-input','id'=>'merchant_order_id','value'=>Input::old('merchant_order_id'), 'placeholder' => 'Enter Merchant Order ID', 'tabindex' => '15']) !!}
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8 {!! $errors->has('special_instruction') ? 'has-error' : ''  !!}">
                            <div class="form-group">
                                ...
                                {!! Form::textarea('special_instruction', null, ['class' => 'form-control m-input','id'=>'special_instruction', 'rows' => "6", 'value'=>Input::old('special_instruction'), 'placeholder' => 'Enter instruction !', 'tabindex' => '16']) !!}
        ...
        <div class="m-portlet__foot clearfix">
            <div class="row">
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 col-lg-offser-2 col-md-offset-2 col-sm-offset-2">
                    <div class="pull-left">
                        <button class="btn btn-default" tabindex="20" name="save" value="save">
                            <i class="fa fa-check-circle text-success fa-lg" aria-hidden="true"></i>
                            <span class="text-success"> Save </span>
                        </button>

                        <button class="btn btn-default" tabindex="20" name="save" value="form_submit_n_print">
    ...
    <script>
        ...
        $(document).ready(function () {
            $(".reset-form").click(function() {
                $(':input','#add-delivery').not(':button, :submit, :reset, :hidden').val('').removeAttr('checked').removeAttr('selected');
            });
            ...
            $(".selectMerchant").change(function()
            {
                ...
                ({
                    type: "POST",
                    url: "{!! route('admin.delivery.merchants.return.plans') !!}",
                    data: {"_token": "{{ csrf_token() }}", "merchant_id": merchant_id},
                    cache: false,
                    beforeSend: function(){
                        $('#loader1').show();
                    ...
                    success: function(html)
                    {
                        $("#selectPlanReturn").html(html);
                    }
                });
            });

            $("#recipient_number").change(function () {
                var number = $(this).val();
                if (number.length > 10)
                {
                    $.ajax
                    ({
                        type: "POST",
                        url: "{!! route('admin.delivery.check.user') !!}",
                        data: {"_token": "{{ csrf_token() }}", "recipient_number": number},
                        cache: false,
                        beforeSend: function(){
                            $('#loader1').show();
                        },
                        ...
                        success: function(data)
                        {
                            ...
                            var checkX = confirm("Auto complete the form instead of manual !!!");
                            if (checkX == true)
                            {
                                $("#recipient_name").val(data.resp.recipient_name);
                                $("#recipient_number").val(data.resp.recipient_number);
                                $("#recipient_email").val(data.resp.recipient_email);
                                $("#selectZone").val(data.resp.recipient_zone_id);
                                $(".recipient_address").val(data.resp.recipient_address);
                                $(".g_map_recipient_address").val(data.resp.recipient_address);
                                $("#latInput").val(data.resp.latitude);
                                $("#lngInput").val(data.resp.longitude);
