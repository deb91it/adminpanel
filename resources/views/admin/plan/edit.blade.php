                ...
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 col-lg-offset-2 col-md-offset-2 col-sm-offset-2">
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 {!! $errors->has('plan_type') ? 'has-error' : '' !!}">
                                <label>Type<span class="text-danger">*</span></label>
                                {!! Form::select('plan_type', ["DELIVERED" => "DELIVERED", "RETURNED" => "RETURNED"],$plan->plan_type, ['class' => 'form-control m-input','id'=>'charge','value'=>Input::old('plan_type'), 'placeholder' => 'Select Type', 'tabindex' => '1']) !!}
                                {!! $errors->first('plan_type', '<label class="error_txt_size">:message</label>') !!}
                            </div>
                        </div>
                        <div class="form-group m-form__group row">
