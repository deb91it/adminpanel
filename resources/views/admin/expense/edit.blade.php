...
@section('content')
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 col-lg-offset-2 col-md-offset-2 col-sm-offset-2">
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 {!! $errors->has('image_name') ? 'has-error' : '' !!}">
                                <div class="row">
                                    <div class="col-md-8">
                                        <label>Update attachment !!! Upload here .. </label>
                                    ...
                                    <div class="col-md-4">
                                        <img src="{!! $expense->image_url !!}" class="img-rounded" style="height: 80px;width: 85px;">
                                        <label><small>Existing attachment</small></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 {!! $errors->has('payment_date') ? 'has-error' : '' !!}">
                                <label>Payment Date <span class="text-danger">*</span></label>
                                {!! Form::text('payment_date', $expense->payment_date, ['class' => 'form-control m-input ','id'=>'payment_date', 'placeholder' => 'Select Date', 'tabindex' => '1']) !!}
                                {!! $errors->first('payment_date', '<label class="error_txt_size">:message</label>') !!}
                            </div>
                        </div>
                        <div class="form-group m-form__group row">
    ...
    <script>
        ...
        var BootstrapDatetimepicker = function () {
            ...
            //== Private functions
            var demos = function () {
                $('#expense_date, #payment_date').datetimepicker({
                    format: "yyyy-mm-dd",
                    todayHighlight: true,
                    autoclose: true,
                    startView: 2,
